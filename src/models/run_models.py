...
def main():
    ...
    try:
        ...
        with mlflow.start_run():
            ...
            display_cols = ['id', 'title', 'event_title', 'yes_price', 'volume', 'liquidity', 'is_anomaly', 'master_score', 'research_note', 'liquidity_imbalance', 'bid_ask_spread', 'news_sentiment_score']
