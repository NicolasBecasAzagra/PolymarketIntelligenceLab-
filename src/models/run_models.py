...
def main():
    ...
    try:
        ...
        with mlflow.start_run():
            ...
            display_cols = ['id', 'title', 'event_title', 'outcome', 'yes_price', 'volume', 'liquidity', 'is_anomaly', 'master_score', 'directional_confidence', 'research_note', 'top_news_headline', 'liquidity_imbalance', 'bid_ask_spread', 'news_sentiment_score']
